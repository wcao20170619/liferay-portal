...
@Meta.OCD(
	id = "com.liferay.portal.search.elasticsearch7.configuration.CCRLocalElasticsearchConfiguration",
	localization = "content/Language",
	name = "elasticsearch7-ccr-local-configuration-name"
)
public interface CCRLocalElasticsearchConfiguration
	extends ElasticsearchConfiguration {

	@Meta.AD(
		deflt = "LOCAL", description = "ccr-cluster-type-help",
		name = "ccr-cluster-type", required = false
	)
	public CCRClusterType ccrClusterType();

	@Meta.AD(
		deflt = "http://localhost:9211",
