...
@Meta.OCD(
	id = "com.liferay.portal.search.elasticsearch7.configuration.CCRRemoteElasticsearchConfiguration",
	localization = "content/Language",
	name = "elasticsearch7-ccr-remote-configuration-name"
)
public interface CCRRemoteElasticsearchConfiguration
	extends ElasticsearchConfiguration {

	@Meta.AD(
		deflt = "REMOTE", description = "ccr-cluster-type-help",
		name = "ccr-cluster-type", required = false
	)
	public CCRClusterType ccrClusterType();

	@Meta.AD(
		deflt = "http://localhost:9210",
