...
import com.liferay.portal.search.elasticsearch7.internal.HighlighterWithAnalyzersFixture;
import com.liferay.portal.search.elasticsearch7.internal.HighlighterWithAnalyzersFixtureFactory;
...
public class HighlighterWithAnalyzersTest extends BaseIndexingTestCase {
	...
	public void testHighlightingEnglish() throws Exception {
		...
		_assertSearch(
			...
			Arrays.asList("article1", "articles", "articlez", "journal"),
			_TEST_EN_US, query, _TEST_EN_US);
		...
		_assertSearch(
			...
			_toFullHighlights(
				...
				"[H]journal[/H]"),
			_TEST_EN_US, query, snippetFieldName);
	}
	...
	public void testHighlightingSynonymNoStopword() throws Exception {
		...
		_assertSearch(
			queryConfig -> queryConfig.setHighlightFragmentSize(20),
			Arrays.asList(""), _TEST_NO_STOPWORD_EN_US, query,
			_TEST_NO_STOPWORD_EN_US);
		_assertSearch(
			queryConfig -> queryConfig.setHighlightFragmentSize(20),
		...
		_assertSearch(
			queryConfig -> queryConfig.setHighlightFragmentSize(20),
			Arrays.asList("for you"), _TEST_NO_STOPWORD_EN_US, query,
			_TEST_NO_STOPWORD_EN_US);
		_assertSearch(
			queryConfig -> queryConfig.setHighlightFragmentSize(20),
	...
	public void testHighlightingSynonyms() throws Exception {
		...
		_assertSearch(
			queryConfig -> queryConfig.setHighlightFragmentSize(20),
			_toFullHighlights(
				"[H]article[/H]", "[H]articles[/H]", "[H]article1[/H]",
				"[H]articlez[/H]", "[H]journal[/H]"),
	...
	public void testHighlightingSynonymStopword() throws Exception {
		...
		_assertSearch(
			queryConfig -> queryConfig.setHighlightFragmentSize(20),
			_toFullHighlights("[H]thing[/H] with [H]words[/H]"),
			_TEST_STOPWORD_EN_US, query, snippetFieldName);
