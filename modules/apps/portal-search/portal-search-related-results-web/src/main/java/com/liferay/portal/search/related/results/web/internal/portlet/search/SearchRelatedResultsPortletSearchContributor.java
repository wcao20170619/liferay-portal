...
public class SearchRelatedResultsPortletSearchContributor
	...
	public void contribute(
		...
		Integer maxItemDisplay = (Integer)renderRequest.getAttribute(
			"maxItemDisplay");

		if (maxItemDisplay != null) {
			setEnd(searchRequestBuilder, maxItemDisplay);
		}

		String entryClassName = (String)renderRequest.getAttribute(
			DocumentUIDBuilder.ENTRYCLASSNAME);

		if (!Validator.isBlank(entryClassName)) {
			searchRequestBuilder.addComplexQueryPart(
				_complexQueryPartBuilderFactory.builder(
				).field(
					DocumentUIDBuilder.ENTRYCLASSNAME
	...
	protected void setEnd(
		SearchRequestBuilder searchRequestBuilder, int maxItemDisplay) {

		searchRequestBuilder.withSearchContext(
			searchContext -> searchContext.setEnd(maxItemDisplay));
	}
