...
public class SearchRelatedResultsPortletSearchContributor
	...
	public void contribute(
		...
		renderRequest.setAttribute("uid", uid);
		...
		setEnd(searchRequestBuilder, searchRelatedResultsPortletPreferences);
	...
	protected void setEnd(
		...
		//searchRelatedResultsPortletPreferences.getSize();

		searchRequestBuilder.withSearchContext(
			searchContext -> searchContext.setEnd(10));
	}
