 ...
 */
public class NoAutoCommitIndexerImpl<T> implements NoAutoCommitIndexer<T> {

	public NoAutoCommitIndexerImpl(Indexer<T> indexer) {
		_indexer = indexer;
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof NoAutoCommitIndexerImpl<?>)) {
			return false;
		}

		NoAutoCommitIndexerImpl<?> noAutoCommitIndexerImpl =
			(NoAutoCommitIndexerImpl<?>)object;

		return Objects.equals(_indexer, noAutoCommitIndexerImpl._indexer);
	}
