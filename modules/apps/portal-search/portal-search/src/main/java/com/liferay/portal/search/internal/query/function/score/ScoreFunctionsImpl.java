 ...
 * @author Wade Cao
 */
@Component(immediate = true, service = ScoreFunctions.class)
public class ScoreFunctionsImpl implements ScoreFunctions {
	...
	@Override
	public GuassianDecayScoreFunction guassianDecay(
		String field, Object origin, Object scale, Object offset) {

		return new GuassianDecayScoreFunctionImpl(field, origin, scale, offset);
	}
	...
	public GuassianDecayScoreFunction guassianDecay(
		...
		return new GuassianDecayScoreFunctionImpl(
			field, origin, scale, offset, decay);
	}
	...
	@Override
	public WeightScoreFunction weight() {
		return new WeightScoreFunctionImpl();
	}
