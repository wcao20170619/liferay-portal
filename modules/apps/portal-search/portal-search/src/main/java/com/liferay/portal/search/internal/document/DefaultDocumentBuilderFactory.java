...
public class DefaultDocumentBuilderFactory implements DocumentBuilderFactory {
	...
	public DocumentBuilder getBuilder() {
		return new DocumentBuilderImpl(_fieldRegistry, _documentTranslator);
	}
	...
	public void processSortFields(SearchContext searchContext) {
		...
		for (Sort sort : sorts) {
			sort.setFieldName(
				_fieldRegistry.getSortableName(sort.getFieldName()));
		}
	}

	@Reference
	private DocumentTranslator _documentTranslator;
