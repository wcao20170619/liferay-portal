...
public class RangeImpl implements Range {
	...
	public static Range unboundedFrom(Double from) {
		return new RangeImpl(from, null);
	}

	public static Range unboundedFrom(String key, Double from) {
		return new RangeImpl(key, from, null);
	}

	public static Range unboundedTo(Double to) {
		return new RangeImpl(null, to);
	}

	public static Range unboundedTo(String key, Double to) {
		return new RangeImpl(key, null, to);
	}

	public RangeImpl(Double from, Double to) {
		_from = from;
		_fromAsString = null;
		_to = to;
		_toAsString = null;
	...
	public RangeImpl(String key, Double from, Double to) {
		_key = key;
		_from = from;
		_fromAsString = null;
		_to = to;
	...
	public RangeImpl(String from, String to) {
		_from = null;
		_fromAsString = from;
		_to = null;
		_toAsString = to;
	...
	public RangeImpl(String key, String from, String to) {
		_key = key;
		_from = null;
		_fromAsString = from;
		_to = null;
