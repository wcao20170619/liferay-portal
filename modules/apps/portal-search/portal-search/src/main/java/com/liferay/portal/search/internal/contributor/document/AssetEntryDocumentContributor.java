...
//				Field.EXPIRATION_DATE, assetEntry.getExpirationDate());
		...
		documentBuilder.add(Field.PRIORITY, assetEntry.getPriority());
		...
		if (assetEntry.getPublishDate() != null) {
			...
			documentBuilder.add(Field.PUBLISH_DATE, new Date(0));
		}

//		document.addLocalizedKeyword(
//			"localized_title", //			populateMap(assetEntry,
			//assetEntry.getTitleMap()), true, true);
		documentBuilder.add(
			"localized_title",
