 ...
 */
public class IndexerRequestImpl implements IndexerRequest {

	public IndexerRequestImpl(
		Method method, ClassedModel classedModel, Indexer<?> indexer) {

		_method = method;
		_classedModel = classedModel;

		_indexer = new NoAutoCommitIndexerImpl<>(indexer);
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof IndexerRequestImpl)) {
			return false;
		}

		IndexerRequestImpl indexerRequestImpl = (IndexerRequestImpl)object;

		if (Objects.equals(_indexer, indexerRequestImpl._indexer) &&
			(Objects.equals(_method, indexerRequestImpl._method) ||
			 (Objects.equals(
				 _method.getName(), indexerRequestImpl._method.getName()) &&
			  Objects.equals(
				  _modelPrimaryKey, indexerRequestImpl._modelPrimaryKey))) &&
			Objects.equals(
				_modelClassName, indexerRequestImpl._modelClassName)) {
