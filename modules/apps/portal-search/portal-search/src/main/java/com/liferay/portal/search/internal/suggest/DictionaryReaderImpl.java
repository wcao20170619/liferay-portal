...
public class DictionaryReaderImpl implements DictionaryReader {
	...
	public DictionaryReaderImpl(InputStream inputStream)
		throws UnsupportedEncodingException {

		this(inputStream, StringPool.UTF8);
	}

	public DictionaryReaderImpl(InputStream inputStream, String encoding)
		throws UnsupportedEncodingException {
	...
	private class DictionaryIterator implements Iterator<DictionaryEntry> {
		...
		public DictionaryEntry next() {
			...
			return new DictionaryEntryImpl(_line);
		}
