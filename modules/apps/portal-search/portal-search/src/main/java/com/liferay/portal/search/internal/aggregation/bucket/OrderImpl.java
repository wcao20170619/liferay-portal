...
public class OrderImpl implements Order {
	...
	public static final Order count(boolean ascending) {
		Order order = new OrderImpl(null);
	...
	public boolean equals(Object object) {
		...
		if (_ascending != order.isAscending()) {
			return false;
		}

		if (!Objects.equals(_metricName, order.getMetricName())) {
			return false;
		}

		if (!Objects.equals(_path, order.getPath())) {
			return false;
		}
