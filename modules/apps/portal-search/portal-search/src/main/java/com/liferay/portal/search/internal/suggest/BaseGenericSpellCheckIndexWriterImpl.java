 ...
 */
public abstract class BaseGenericSpellCheckIndexWriterImpl
	extends BaseSpellCheckIndexWriterImpl
	implements BaseGenericSpellCheckIndexWriter {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BaseGenericSpellCheckIndexWriterImpl.class);

	private static final NGramHolderBuilder _defaultNGramHolderBuilder =
		new NullNGramHolderBuilderImpl();
