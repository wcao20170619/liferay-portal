...
public class GeoLocationPointImpl implements GeoLocationPoint {
	...
	public GeoLocationPointImpl(double latitude, double longitude) {
		_latitude = latitude;
	...
	public GeoLocationPointImpl(String geoHash) {
		_geoHash = geoHash;
	...
	public boolean equals(Object object) {
		...
		final GeoLocationPointImpl geoLocationPoint =
			(GeoLocationPointImpl)object;
