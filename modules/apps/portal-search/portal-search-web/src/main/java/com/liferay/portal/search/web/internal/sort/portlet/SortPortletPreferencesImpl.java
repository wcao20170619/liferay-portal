...
import com.liferay.portal.search.web.internal.sort.display.context.SortTypePreference;
...
public class SortPortletPreferencesImpl implements SortPortletPreferences {
	...
	@Override
	public SortTypePreference[] getSortTypePreferences() {
		return SortTypePreference.getSortTypePreferences();
	}
