...
page import="com.liferay.portal.search.web.internal.sort.display.context.SortTypePreference" %><%@
...
SortTypePreference[] sortTypePreferences = sortPortletPreferences.getSortTypePreferences();
%>
