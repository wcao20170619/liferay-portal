	...
	<div class="portlet-configuration-body-content">
		<div class="container-fluid-1280">
			<aui:fieldset>
				...
				<aui:input helpMessage="use-advanced-search-syntax-help" name="preferences--useAdvancedSearchSyntax--" type="checkbox" value="<%= searchBarPortletPreferences.isUseAdvancedSearchSyntax() %>" />
			</aui:fieldset>
		</div>
	</div>
