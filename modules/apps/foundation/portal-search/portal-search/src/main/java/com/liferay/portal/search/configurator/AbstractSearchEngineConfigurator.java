...
package com.liferay.portal.search.configurator;
...
public abstract class AbstractSearchEngineConfigurator
			...
			new ServiceDependencyListener() {
				...
				public void dependenciesFulfilled() {
					...
					_messageBusServiceReference =
						bundleContext.getServiceReference(MessageBus.class);

					_messageBus = bundleContext.getService(
						_messageBusServiceReference);
	...
	public void destroy() {
		...
		if (_messageBusServiceReference != null) {
			...
			bundleContext.ungetService(_messageBusServiceReference);
		}
	}
