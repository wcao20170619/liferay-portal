...
public class CollatedSpellCheckHitsProcessorTest {
	...
	public void testProcess() throws Exception {
		Mockito.when(
			indexSearcherHelper.spellCheckKeywords(
				(SearchContext)Matchers.any())
		).thenReturn(
			"abc"
		);

		CollatedSpellCheckHitsProcessor comp =
			new CollatedSpellCheckHitsProcessor();
