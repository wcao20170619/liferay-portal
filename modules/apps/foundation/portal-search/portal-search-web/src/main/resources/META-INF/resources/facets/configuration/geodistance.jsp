...
<aui:input label="center-point-latitude-longitude" name='<%= searchFacet.getClassName() + "centerPoint" %>' value="<%= centerPoint %>" />

<aui:input label="geolocation-field-name" name='<%= searchFacet.getClassName() + "geoLocationFieldName" %>' value="<%= geoLocationFieldName %>" />

<aui:fieldset id="GEODISTANCErangesId">
...
<aui:script use="liferay-auto-fields">
	var autoFields = new Liferay.AutoFields(
		{
			contentBox: 'fieldset#<portlet:namespace />GEODISTANCErangesId',
