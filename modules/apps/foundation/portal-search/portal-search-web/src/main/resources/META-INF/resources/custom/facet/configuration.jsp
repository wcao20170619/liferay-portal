...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm">
	...
	<div class="portlet-configuration-body-content">
		<div class="container-fluid-1280">
			<aui:input label="custom-parameter-name" name="<%= PortletPreferencesJspUtil.getInputName(CustomFacetPortletPreferences.PREFERENCE_KEY_PARAMETER_NAME) %>" value="<%= customFacetPortletPreferences.getParameterName() %>" />

			<aui:input label="field-label" name="<%= PortletPreferencesJspUtil.getInputName(CustomFacetPortletPreferences.PREFERENCE_KEY_FIELD_LABEL) %>" value="<%= customFacetPortletPreferences.getFieldLabel() %>" />

			<aui:input label="field-to-aggregate" name="<%= PortletPreferencesJspUtil.getInputName(CustomFacetPortletPreferences.PREFERENCE_KEY_FIELD_TO_AGGREGATE) %>" value="<%= customFacetPortletPreferences.getFieldToAggregate() %>" />
