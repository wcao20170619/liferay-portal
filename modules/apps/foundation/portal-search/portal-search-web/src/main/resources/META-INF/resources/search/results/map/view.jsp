...
<%
com.liferay.portal.search.web.search.results.map.portlet.SearchResultsMapDisplayContext dc =
	new com.liferay.portal.search.web.search.results.map.portlet.SearchResultsMapDisplayContext(request);
%>
