...
public class ElasticsearchAggregationVisitorFixture {
	...
	protected void injectGeoAggregationTranslators(
		ElasticsearchAggregationVisitor elasticsearchAggregationVisitor) {
	...
	protected void injectQueryAggregationTranslators(
		ElasticsearchAggregationVisitor elasticsearchAggregationVisitor,
		ElasticsearchQueryTranslatorFixture
			elasticsearchQueryTranslatorFixture) {
		...
		elasticsearchAggregationVisitor.setSignificantTermsAggregationTranslator(
	...
	protected void injectScriptAggregationTranslators(
		ElasticsearchAggregationVisitor elasticsearchAggregationVisitor) {
	...
	protected void injectTopHitsAggregationTranslators(
		ElasticsearchAggregationVisitor elasticsearchAggregationVisitor,
		ElasticsearchQueryTranslatorFixture
			elasticsearchQueryTranslatorFixture) {
