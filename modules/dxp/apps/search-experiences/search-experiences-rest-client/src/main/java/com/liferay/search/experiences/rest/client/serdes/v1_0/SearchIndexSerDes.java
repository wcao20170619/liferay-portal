...
public class SearchIndexSerDes {
	...
	public static String toJSON(SearchIndex searchIndex) {
		...
		if (searchIndex.getFullName() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(searchIndex.getFullName()));
	...
	public static Map<String, String> toMap(SearchIndex searchIndex) {
		...
		if (searchIndex.getFullName() == null) {
			...
			map.put("fullName", String.valueOf(searchIndex.getFullName()));
		}
	...
	public static class SearchIndexJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "fullName")) {
				if (jsonParserFieldValue != null) {
					searchIndex.setFullName((String)jsonParserFieldValue);
				}
			}
