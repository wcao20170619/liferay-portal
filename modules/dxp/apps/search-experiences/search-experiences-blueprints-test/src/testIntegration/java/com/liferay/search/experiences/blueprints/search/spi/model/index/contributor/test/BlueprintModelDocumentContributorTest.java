...
public class BlueprintModelDocumentContributorTest {
	...
	public void testContributor() throws Exception {
		...
		_assertResults(fieldName, searchTerm);
		
	}
	
	@Test
	public void testPortalInstanceLifecycleListener() throws Exception {
		String fieldName = "title_en_US";
		
		_assertResults(fieldName, "alpha");
		_assertResults(fieldName, "charlie");
	}
	
	private void _assertResults(String fieldName, String searchTerm) throws Exception {
