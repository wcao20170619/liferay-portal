...
<%
	...
	(SearchConfigurationsDisplayContext)request.getAttribute(SearchConfigurationWebKeys.SEARCH_CONFIGURATIONS_DISPLAY_CONTEXT);

SearchConfigurationAdminManagementToolbarDisplayContext searchConfigurationsManagementToolbarDisplayContext = 
	(SearchConfigurationAdminManagementToolbarDisplayContext)request.getAttribute(SearchConfigurationWebKeys.SEARCH_CONFIGURATIONS_MANAGEMENT_TOOLBAR_DISPLAY_CONTEXT);
