...
package com.liferay.portal.search.tuning.blueprints.result.view.web.internal.hit.contributor;
...
import com.liferay.portal.search.tuning.blueprints.result.view.web.internal.util.ResultUtil;
...
public class ViewURLHitContributor implements HitContributor {
	...
	private PortletURL _getViewContentURL(
		...
		PortletURL viewContentURL = liferayPortletResponse.createRenderURL(
			ResultViewWebPortletKeys.RESULT_VIEW_WEB);
