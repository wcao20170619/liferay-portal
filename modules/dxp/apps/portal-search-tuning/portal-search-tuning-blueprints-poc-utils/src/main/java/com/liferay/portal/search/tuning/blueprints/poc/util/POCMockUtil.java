...
*/
		...
		*/
		...
		advancedConfigurationJsonObject.put(
				AdvancedConfigurationKeys.ENTRY_CLASS_NAMES.getJsonKey(), indexersJsonArray);
	...
	public void mockSortConfiguration(JSONObject bluePrintJsonObject) {
		...
		sortConfigurationJsonObject2.put(
			SortConfigurationKeys.FIELD.getJsonKey(), "localized_title_${context.language_id}_sortable");
		sortConfigurationJsonObject2.put(
				SortConfigurationKeys.LABEL.getJsonKey(), "title");
		...
		bluePrintJsonObject.put(BlueprintKeys.SORT_CONFIGURATION.getJsonKey(), 
