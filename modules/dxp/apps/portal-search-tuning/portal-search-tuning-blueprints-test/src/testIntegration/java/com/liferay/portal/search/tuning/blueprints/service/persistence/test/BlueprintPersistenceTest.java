...
public class BlueprintPersistenceTest {
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertTrue(
			Objects.equals(
				existingBlueprint.getUuid(),
				ReflectionTestUtil.invoke(
					existingBlueprint, "getOriginalUuid", new Class<?>[0])));
		Assert.assertEquals(
			Long.valueOf(existingBlueprint.getGroupId()),
			ReflectionTestUtil.<Long>invoke(
				existingBlueprint, "getOriginalGroupId", new Class<?>[0]));
	}
