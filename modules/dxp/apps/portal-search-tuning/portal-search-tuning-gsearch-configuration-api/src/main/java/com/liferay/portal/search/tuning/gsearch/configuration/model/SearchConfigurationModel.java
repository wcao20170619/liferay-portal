...
/**
 * The base model interface for the SearchConfiguration service. Represents a row in the &quot;SearchConfiguration&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.portal.search.tuning.gsearch.configuration.model.impl.SearchConfigurationModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.portal.search.tuning.gsearch.configuration.model.impl.SearchConfigurationImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface SearchConfigurationModel
	extends BaseModel<SearchConfiguration>, GroupedModel, LocalizedModel,
			MVCCModel, ShardedModel, StagedAuditedModel, WorkflowedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a search configuration model instance should use the {@link SearchConfiguration} interface instead.
	 */
