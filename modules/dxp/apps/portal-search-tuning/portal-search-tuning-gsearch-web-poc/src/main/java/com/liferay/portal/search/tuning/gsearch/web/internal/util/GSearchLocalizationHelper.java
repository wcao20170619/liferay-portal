...
package com.liferay.portal.search.tuning.gsearch.web.internal.util;
...
@Component(
	...
	service = GSearchLocalizationHelper.class
)
public class GSearchLocalizationHelper {
	...
	private ResourceBundle _getCommonResourceBundle(Locale locale) {
		ResourceBundle classResourceBundle = ResourceBundleUtil.getBundle(
			locale, "com.liferay.portal.search.tuning.gsearch.lang");
