...
public class FloatParameterContributor implements RequestParameterContributor {
	...
	public void contribute(
		...
		Optional<Float> valueOptional = ValueUtil.stringToFloatOptional(
			valueString);

		if (!valueOptional.isPresent()) {
			valueOptional = ValueUtil.stringToFloatOptional(
		...
		Optional<Float> minValue = ValueUtil.stringToFloatOptional(
			configurationJsonObject.getString(
