...
package com.liferay.portal.search.tuning.blueprints.engine.impl.internal.spellcheck;
...
import com.liferay.portal.search.tuning.blueprints.constants.json.keys.SpellCheckerConfigurationKeys;
import com.liferay.portal.search.tuning.blueprints.engine.context.SearchRequestContext;
import com.liferay.portal.search.tuning.blueprints.engine.impl.internal.suggester.SuggesterHelper;
import com.liferay.portal.search.tuning.blueprints.engine.spellcheck.SpellChecker;
	...
	public JSONArray getSuggestions(SearchRequestContext searchRequestContext) {
		...
		if (!spellCheckerConfigurationJsonObjectOptional.isPresent()) {
			if (_log.isDebugEnabled()) {
				_log.debug(
					"Spell checker configuration not available in search configuration " +
