...
public class LongParameterContributor implements RequestParameterContributor {
	...
	public void contribute(
		...
		Optional<Long> valueOptional = ValueUtil.stringToLongOptional(
			valueString);

		if (!valueOptional.isPresent()) {
			valueOptional = ValueUtil.stringToLongOptional(
		...
		Optional<Long> minValue = ValueUtil.stringToLongOptional(
			configurationJsonObject.getString(
		...
		Optional<Long> maxValue = ValueUtil.stringToLongOptional(
			configurationJsonObject.getString(
