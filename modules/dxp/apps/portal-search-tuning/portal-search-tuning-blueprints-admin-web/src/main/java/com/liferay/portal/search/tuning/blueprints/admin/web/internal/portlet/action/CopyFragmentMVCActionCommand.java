...
@Component(
	...
	property = {
		...
		"mvc.command.name=" + BlueprintsAdminMVCCommandNames.COPY_FRAGMENT
	},
	service = MVCActionCommand.class
)
public class CopyFragmentMVCActionCommand extends BaseMVCActionCommand {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CopyFragmentMVCActionCommand.class);
