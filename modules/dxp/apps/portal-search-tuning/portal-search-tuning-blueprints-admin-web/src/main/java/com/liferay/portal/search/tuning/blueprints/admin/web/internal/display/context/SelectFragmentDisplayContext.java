 ...
 * @author Kevin Tan
 */
public class SelectFragmentDisplayContext {

	public SelectFragmentDisplayContext(
	...
	public String getEventName() {
		...
		_eventName = ParamUtil.getString(
			...
			_liferayPortletResponse.getNamespace() + "selectFragment");
	...
	public SearchContainer<Blueprint> getSearchContainer()
		...
		portletURL.setParameter(
			...
			BlueprintsAdminMVCCommandNames.SELECT_FRAGMENT);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SelectFragmentDisplayContext.class);
